!(function (e, t) {
  ...
  var ce,
    ...
    Be = function (e, t) {
      var n,
        ...
        o = 0,
        r = [];
      for (n in i) !Z($, n) && Z(i, n) && r.push(n);
      for (; t.length > o; ) Z(i, (n = t[o++])) && (~Ce(r, n) || r.push(n));
      return r;
    },
    Fe = [
      'constructor',
    ...
    Ge = function (e, t) {
      for (var n = Ve(t), i = J.f, o = A.f, r = 0; r < n.length; r++) {
        var c = n[r];
        Z(e, c) || i(e, c, o(t, c));
      }
    },
    ...
    ke = function (e, t) {
      ...
      if ((n = a ? l : u ? l[s] || k(s, {}) : (l[s] || {}).prototype))
        for (i in t) {
          if (
            ((r = t[i]),
            (o = e.noTargetGet ? (c = We(n, i)) && c.value : n[i]),
            !Je(a ? i : s + (u ? '.' : '#') + i, e.forced) && void 0 !== o)
          ) {
    ...
    { target: 'Array', proto: !0, forced: !mt || !vt },
    {
      concat: function (e) {
        ...
        for (t = -1, i = arguments.length; t < i; t++)
          if (Ct((r = -1 === t ? c : arguments[t]))) {
            if (a + (o = pe(r.length)) > yt) throw TypeError(bt);
            for (n = 0; n < o; n++, a++) n in r && st(s, a, r[n]);
          } else {
  ...
  var Gt,
    ...
    wt = g
      ...
      : function (e, t) {
          R(e);
          for (var n, i = Xt(t), o = i.length, r = 0; o > r; )
            J.f(e, (n = i[r++]), t[n]);
          return e;
        },
  ...
  var Wt =
    ...
    Nt = function (e) {
      ...
      Z(t, e) || Yt(t, e, { value: Et.f(e) });
    },
    Kt = J.f,
    Ot = Ne('toStringTag'),
    zt = function (e, t, n) {
      e &&
        !Z((e = n ? e : e.prototype), Ot) &&
    ...
    mn = function (e, t, n) {
      ...
      return (
        ...
        Z(un, i)
          ? (n.enumerable
              ? (Z(e, Pt) && e[Pt][i] && (e[Pt][i] = !1),
                (n = Wt(n, { enumerable: p(0, !1) })))
              : (Z(e, Pt) || cn(e, Pt, p(1, {})), (e[Pt][i] = !0)),
            pn(e, i, n))
          : cn(e, i, n)
      );
    },
    ...
    Cn = function (e) {
      var t = U(e, !0),
        n = an.call(this, t);
      return (
        !(this === tn && Z(un, t) && !Z(ln, t)) &&
        (!(n || !Z(this, t) || !Z(un, t) || (Z(this, Pt) && this[Pt][t])) || n)
      );
    },
    Bn = function (e, t) {
      var n = B(e),
        i = U(t, !0);
      if (n !== tn || !Z(un, i) || Z(ln, i)) {
        var o = rn(n, i);
        return (
          !o || !Z(un, i) || (Z(n, Pt) && n[Pt][i]) || (o.enumerable = !0), o
        );
      }
    },
    Fn = function (e) {
      ...
      (ae(
        (nn = function () {
          ...
          var e =
            ...
            n = function (e) {
              this === tn && n.call(ln, e),
                Z(this, Pt) && Z(this[Pt], t) && (this[Pt][t] = !1),
                pn(this, t, p(1, e));
            };
  ...
  ii(
    ...
    'String',
    function (e) {
      ci(this, { type: ri, string: String(e), index: 0 });
    },
    function () {
      var e,
        t = si(this),
      ...
      return i >= n.length
        ? { value: void 0, done: !0 }
        : ((e = oi(n, i)), (t.index += e.length), { value: e, done: !1 });
    }
  );
  var ai = function (e) {
      var t = e.return;
    ...
    Ii = function (e) {
      if (null != e) return e[fi] || e['@@iterator'] || zn[Zt(e)];
    },
    hi = Ne('iterator'),
    pi = !1;
  try {
    ...
    { target: 'Array', stat: !0, forced: vi },
    {
      from: function (e) {
        ...
        if (
          ...
          for (
            r = (o = g.call(s)).next, n = new a();
            !(i = r.call(o)).done;
            f++
          )
            (c = d ? ui(o, l, [i.value, f], !0) : i.value), st(n, f, c);
        return (n.length = f), n;
      }
    }
  );
  ...
  if ((Qi && Yn(Vi) !== Xi && _n(Vi, Xi), g && !Z(Xi, Ai)))
    for (Ci in (!0,
    Fi(Xi, Ai, {
      get: function () {
  ...
  var qi = !d(function () {
    ...
    $i = a(function (e) {
      var t = J.f,
        ...
        c = (e.exports = {
          ...
          onFreeze: function (e) {
            return qi && c.REQUIRED && o(e) && !Z(e, n) && r(e), e;
          }
        });
      $[n] = !0;
    }),
    ...
    to = function (e, t, n) {
      ...
      if (g) i = e;
        ...
        if ('function' != typeof (o = Ii(e)))
          throw TypeError('Target is not iterable');
        if (gi(o)) {
          for (r = 0, c = pe(e.length); c > r; r++)
            if ((s = p(e[r])) && s instanceof eo) return s;
          return new eo(!1);
        }
        i = o.call(e);
      }
      for (a = i.next; !(u = a.call(i)).done; ) {
        ...
        if ('object' == typeof s && s && s instanceof eo) return s;
      }
      return new eo(!1);
    },
    no = function (e, t, n) {
    ...
    uo =
      ((function (e, t, n) {
        ...
        if (
          ...
          (a = n.getConstructor(t, e, i, r)), ($i.REQUIRED = !0);
        else if (Je(e, !0)) {
          var f = new a(),
            I = f[r](o ? {} : -0, 1) != f,
            h = d(function () {
          ...
          p ||
            (((a = t(function (t, n) {
              ...
              return null != n && to(n, o[r], { that: o, AS_ENTRIES: i }), o;
            })).prototype = s),
            (s.constructor = a)),
          ...
          getConstructor: function (e, t, n, i) {
            var o = e(function (e, r) {
                no(e, o, t),
                  ...
                  g || (e.size = 0),
                  null != r && to(r, e[i], { that: e, AS_ENTRIES: n });
              }),
              r = ao(t),
              c = function (e, t, n) {
                var i,
    ...
    Io = ii(
      ...
      'Array',
      function (e, t) {
        go(this, { type: lo, target: B(e), index: 0, kind: t });
      },
      function () {
        var e = fo(this),
          t = e.target,
        ...
        Vo._immediateFn(function () {
          ...
          if (null !== n) {
            ...
            try {
              ...
              return void wo(t.promise, e);
            }
            Xo(t.promise, i);
          } else (1 === e._state ? Xo : wo)(t.promise, e._value);
        }))
      : e._deferreds.push(t);
  }
  function Xo(e, t) {
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        var n = t.then;
        if (t instanceof Vo) return (e._state = 3), (e._value = t), void xo(e);
  ...
  function xo(e) {
    ...
    for (var t = 0, n = e._deferreds.length; t < n; t++) Go(e, e._deferreds[t]);
    e._deferreds = null;
  }
  function Ao(e, t, n) {
  ...
  (Vo.prototype.catch = function (e) {
    ...
    (Vo.prototype.then = function (e, t) {
      var n = new this.constructor(Zo);
      return Go(this, new Ao(e, t, n)), n;
    }),
    (Vo.prototype.finally = Bo),
    (Vo.all = function (e) {
      return new Vo(function (t, n) {
        if (!So(e)) return n(new TypeError('Promise.all accepts an array'));
        var i = Array.prototype.slice.call(e);
        if (0 === i.length) return t([]);
        var o = i.length;
        function r(e, c) {
    ...
    (Vo.race = function (e) {
      return new Vo(function (t, n) {
        if (!So(e)) return n(new TypeError('Promise.race accepts an array'));
        for (var i = 0, o = e.length; i < o; i++) Vo.resolve(e[i]).then(t, n);
      });
    }),
    (Vo._immediateFn =
  ...
  'function' != typeof Qo.Promise
    ? (Qo.Promise = Vo)
    : Qo.Promise.prototype.finally
    ? Qo.Promise.allSettled || (Qo.Promise.allSettled = Fo)
    : (Qo.Promise.prototype.finally = Bo),
    (function (e) {
      function t() {}
      function n(e, t) {
        if (
  ...
  var Wo = s(
                    ...
                    case 0:
                      return (
                        ...
                        null === (c = n.getItem(r))
                          ...
                          ? [3, 2]
                          : [4, Jo.default().lock(c.iat)]
                      );
                    case 1:
                      i.sent(),
                        this.acquiredIatSet.delete(c.iat),
                        n.removeItem(r),
                        Jo.default().unlock(c.iat),
                        e.notifyWaiters(),
                        (i.label = 2);
                    case 2:
                      return [2];
    ...
    To = { name: 'auth0-spa-js', version: '1.13.6' },
    Eo = (function (e) {
      function n(t, i) {
            ...
            if (
              ...
              n && n.close(),
                e.data.response.error
                  ? o(Eo.fromPayload(e.data.response))
                  : i(e.data.response),
                clearTimeout(a),
                window.removeEventListener('message', c, !1),
                setTimeout(s, 2e3);
      ...
      return new Promise(function (e, n) {
        var i,
          o = setTimeout(function () {
            n(new Ko(r)), window.removeEventListener('message', i, !1);
        ...
        (i = function (t) {
          if (t.data && 'authorization_response' === t.data.type) {
            if (
              ...
              return n(Eo.fromPayload(t.data.response));
            e(t.data.response);
          }
        }),
  ...
  var tr = function (e, t) {
    ...
    or = function (e, t, n, i, c, s) {
      return (
        void 0 === s && (s = 1e4),
        o(void 0, void 0, void 0, function () {
          return r(this, function (o) {
            return c ? [2, ir(e, t, n, i, s, c)] : [2, nr(e, i, s)];
          });
        })
      );
    };
  function rr(e, t, n, c, s, a) {
      ...
      return r(this, function (r) {
        switch (r.label) {
          ...
          case 1:
            ...
            r.label = 2;
          case 2:
            return r.trys.push([2, 4, , 5]), [4, or(e, n, c, s, a, t)];
          case 3:
  ...
  var cr = function (e) {
    ...
    sr = function () {
      ...
      return cr(e.join(' ').trim().split(/\s+/)).join(' ');
    };
  function ar(e, t) {
    var n = e.baseUrl,
      c = e.timeout,
  ...
  var ur = (function () {
    ...
    pr = (function () {
      function e(e) {
        (this.storage = e), (this.transaction = this.storage.get(hr));
      }
      return (
        (e.prototype.create = function (e) {
          (this.transaction = e),
            this.storage.save(hr, e, { daysUntilExpire: 1 });
        }),
        (e.prototype.get = function () {
          return this.transaction;
        }),
        (e.prototype.remove = function () {
          delete this.transaction, this.storage.remove(hr);
        }),
        e
      );
    })(),
    ...
    mr = function (e) {
      ...
      var t = (function (e) {
        ...
        var r = JSON.parse($o(i)),
          c = { __raw: e },
          s = {};
        return (
          Object.keys(r).forEach(function (e) {
            (c[e] = r[e]), br.includes(e) || (s[e] = r[e]);
          }),
          {
            encoded: { header: n, payload: i, signature: o },
            header: JSON.parse($o(n)),
            claims: c,
            user: s
          }
        );
      ...
      if (e.max_age && !yr(t.claims.auth_time))
        throw new Error(
  ...
  s(vr);
  vr.encode, vr.parse, vr.getAll, vr.get, vr.set, vr.remove;
  var Cr = {
      get: function (e) {
  ...
  function Fr(e, t, n) {
    var i = void 0 === t ? null : t,
      o = (function (e, t) {
        ...
        if (t) {
          for (
            var i = new Uint8Array(n.length), o = 0, r = n.length;
            o < r;
            ++o
          )
            i[o] = n.charCodeAt(o);
  ...
  var Ur,
    ...
    Gr =
      ...
      (Zr = !1),
      function (e) {
        return (Vr = Vr || Fr(Ur, Sr, Zr)), new Worker(Vr, e);
      }),
    Xr = {},
    wr = new Wo(),
    xr = 'auth0.lock.getTokenSilently',
    Ar = {
      memory: function () {
        return new Ir().enclosedCache;
      },
    ...
    Jr = (function () {
      function e(e) {
        ...
        var o,
          r,
          c = e.useCookiesForTransactions ? this.cookieStorage : Cr;
        (this.cache = Rr(this.cacheLocation)()),
          (this.scope = this.options.scope),
          (this.transactionManager = new pr(c)),
          ...
          this.options.useRefreshTokens &&
            (this.scope = sr(this.scope, 'offline_access')),
          'undefined' != typeof window &&
            window.Worker &&
            this.options.useRefreshTokens &&
      ...
      return (
        ...
        (e.prototype._getParams = function (e, t, o, r, c) {
          ...
          return n(n(n({}, a), e), {
            scope: sr(this.defaultScope, this.scope, e.scope),
            response_type: 'code',
            response_mode: 'query',
            state: t,
            nonce: o,
            ...
            o(this, void 0, void 0, function () {
              ...
              return r(this, function (o) {
                return (
                  ...
                  (n = sr(this.defaultScope, this.scope, e.scope)),
                  (i = this.cache.get(
                    new ur({
                      client_id: this.options.client_id,
                      audience: t,
                ...
                switch (r.label) {
                  ...
                  case 1:
                    return (
                      ...
                      console.log('transcation.appSate = ', u.appState),
            ...
            return r(this, function (n) {
              switch (n.label) {
                ...
                case 2:
                  return n.sent(), [3, 4];
                case 3:
                  if (((t = n.sent()), !Lo.includes(t.error))) throw t;
                  return [3, 4];
                case 4:
                  return [2];
              }
        ...
        (e.prototype._getTokenFromIFrame = function (e) {
          return o(this, void 0, void 0, function () {
            var t, o, c, s, a, u, l, d, g, f, I, h, p, y, b;
            return r(this, function (r) {
              switch (r.label) {
                case 0:
                  return (t = Po(_o())), (o = Po(_o())), (c = _o()), [4, qo(c)];
                case 1:
                  (s = r.sent()),
                    (a = er(s)),
                    (u = this._getParams(
                ...
                case 2:
                  return (
                    r.trys.push([2, 5, , 6]), [4, Oo(l, this.domainUrl, d)]
                  );
                case 3:
                ...
                case 4:
                  return (
                    (p = r.sent()),
                    (y = this._verifyIdToken(p.id_token, o)),
                    [
                      2,
                      n(n({}, p), {
                        decodedToken: y,
  ...
  function Wr(e) {
    return o(this, void 0, void 0, function () {
      ...
      return r(this, function (n) {
        switch (n.label) {
          case 0:
            return [4, (t = new Jr(e)).checkSession()];
          case 1:
            return n.sent(), [2, t];
        }
      });
