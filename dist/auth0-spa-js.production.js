!(function (e, t) {
  ...
  var ce,
    ...
    Be = function (e, t) {
      ...
      for (; t.length > r; ) Z(i, (n = t[r++])) && (~Ce(o, n) || o.push(n));
      return o;
    },
    Fe = [
      'constructor',
  ...
  var Wt =
    ...
    Bn = function (e, t) {
      ...
      if (n !== tn || !Z(un, i) || Z(ln, i)) {
        var r = on(n, i);
        return (
          !r || !Z(un, i) || (Z(n, Pt) && n[Pt][i]) || (r.enumerable = !0), r
        );
      }
    },
    Fn = function (e) {
    ...
    $i = a(function (e) {
      var t = J.f,
        ...
        c = (e.exports = {
          ...
          onFreeze: function (e) {
            return qi && c.REQUIRED && r(e) && !Z(e, n) && o(e), e;
          }
        });
      $[n] = !0;
    }),
  ...
  function Gr(e, t) {
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        var n = t.then;
        if (t instanceof Zr) return (e._state = 3), (e._value = t), void wr(e);
  ...
  function wr(e) {
    2 === e._state &&
      ...
      Zr._immediateFn(function () {
        e._handled || Zr._unhandledRejectionFn(e._value);
      });
  ...
  (Zr.prototype.catch = function (e) {
    return this.then(null, e);
  }),
    (Zr.prototype.then = function (e, t) {
      var n = new this.constructor(Sr);
      return Vr(this, new xr(e, t, n)), n;
    }),
    (Zr.prototype.finally = Cr),
    (Zr.all = function (e) {
      return new Zr(function (t, n) {
    ...
    (Zr.allSettled = Br),
    (Zr.resolve = function (e) {
      return e && 'object' == typeof e && e.constructor === Zr
        ? e
        : new Zr(function (t) {
            t(e);
          });
    }),
    (Zr.reject = function (e) {
      return new Zr(function (t, n) {
        n(e);
      });
    }),
    (Zr.race = function (e) {
      return new Zr(function (t, n) {
        ...
        for (var i = 0, r = e.length; i < r; i++) Zr.resolve(e[i]).then(t, n);
      });
    }),
    (Zr._immediateFn =
    ...
    (Zr._unhandledRejectionFn = function (e) {
    ...
    Bo = {
      get: function (e) {
        if ('undefined' != typeof localStorage) {
          ...
          if (void 0 !== t)
            return console.log('localStorage ok'), JSON.parse(t);
  ...
  var Uo,
    ...
    Go =
      ...
      (Zo = !1),
      function (e) {
        return (Vo = Vo || Fo(Uo, So, Zo)), new Worker(Vo, e);
      }),
    Xo = {},
    wo = new Jr(),
